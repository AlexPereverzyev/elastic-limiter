...
class ElasticCounter {
    constructor(bounds) {
        ...
        this.upper = bounds && bounds.upper ? bounds.upper : this.upper
        this.lower = bounds && bounds.lower ? bounds.lower : this.upper
    ...
    break() {
        ...
        if (this.breaksCount === this.breaksAfter) {
            this.recoversAfter = second() + this.breakDuration
        }
